...
for index, row in df_destinos.iterrows():
    cur.execute(
        ...
        int(row['id_destino']), row['destino'], row['tipo_destino'])
...
for index, row in df_precios.iterrows():
    cur.execute(
        ...
        int(row['id_precio']), row['tipo_destino'], int(row['duracion']), row['transporte'], int(row['sup_hab_ind']), float(row['precio']))
...
for index, row in df_viajes.iterrows():
    cur.execute(
        ...
        int(row['id_viaje']), int(row['id_destino']), int(row['id_precio']))